...
var Yelp = (function () {
  ...
  _createClass(Yelp, [{
    ...
    value: function get(resource) {
      ...
      var url = baseUrl + resource + '?' + _querystring2.default.stringify(params);
      var promise = new Promise(function (resolve, reject) {
        var debug = params.debug;
        delete params.debug;

        _this.oauth.get(url, _this.oauthToken, _this.oauthTokenSecret, function (err, _data, response) {
